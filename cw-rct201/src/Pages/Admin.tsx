...
const Admin = () => {
  ...
  return (
    <div>
     <Box width={"40%"} textAlign="center"  margin={"auto"}> <Button p={7} mb={10} mt={10}  colorScheme={"teal"} onClick={onOpen}> Admin Panel <MdOpenInNew/>  </Button></Box>
      ...
      <Drawer placement="left" onClose={onClose} isOpen={isOpen} size={"sm"}>
        ...
        <DrawerContent>
          ...
          <DrawerBody>
            <Flex borderRadius={"5rem"} boxShadow={"rgba(0, 0, 0, 0.35) 0px 5px 15px;"} justifyContent={"space-around"}>
              <Box mt={10}>
                <Avatar
                  size={"lg"}
      ...
      {currentPortion==="dashboard"?<Box style={{color:"white"}}>
        ...
        >
          ...
          <Box>
            <Box p={7} bgColor={"blue.600"} borderRadius={"1rem"}>
              <Heading fontSize={"30px"}>Total Admins : {totalAdminArr.length}</Heading>
