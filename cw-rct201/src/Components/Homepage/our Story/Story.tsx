...
const Story = () => {
  return (
    ...
    <Flex justifyContent={"space-evenly"} >
          ...
          <GridItem >
          <h1 style={{fontWeight:"bold",fontSize:"40px"}}>OUR STORY</h1>
            <p>Founded in 2012, DailyObjects is a design-obsessed lifestyle accessories brand committed
             to making your everyday carry #lessordinary.</p>
            <p style={{marginTop:"10px"}}>You can look forward to a carefully-crafted range of products,
