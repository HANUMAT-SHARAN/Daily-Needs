  ...
  return (
    ...
    >
      ...
      <Stack
        ...
        p={6}
      >
        <Flex justifyContent={"space-around"}><Heading lineHeight={1.1} fontSize={{ base: "2xl", md: "3xl" }}>
          Add New Product
        </Heading><Heading><AttachmentIcon/></Heading></Flex>
        ...
        <FormControl  id="category">
          <Select    onChange={(e)=>setData({...data,category:e.target.value})} name="category" placeholder="Select option">
