...
import {Box,HStack,Image,Text,Input,Button,VStack,Link,ListItem,List,Show,Flex} from "@chakra-ui/react"
const Footer = () => {
  return (
    <>
    
    <Box bgColor="#f7f7f7" w="100%"  h={{sm:"130px",lg:"300px"}} pt="20px">
        <Box h="30%">
    ...
    <VStack gap={"30px"} p="30px 10px 20px 10px" h="300px" w="100%" mt="5px" bgColor="#f7f7f7">
    ...
    <VStack w="30%" h="100%">
      ...
      <VStack w="30%" h="90%">
        <Box h="50%">
        <Text fontWeight={"600"} color="#202020" fontSize={"25px"} textAlign='center'>FOLLOW US ON</Text>
        <HStack>
        ...
        <Box h="50%">
        <Text fontWeight={"600"} color="#202020" fontSize={"25px"} textAlign='center'>DOWNLOAD OUR APP</Text>
        <HStack>
    ...
    <Text fontWeight={"600"} color="#202020" fontSize={"25px"} textAlign='center'>100% SECURE PAYMENT</Text>
